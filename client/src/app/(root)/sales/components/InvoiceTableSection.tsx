...
export default function InvoiceTableSection({ control, fields, remove, append, watch, setValue, calculateTotals }) {
    ...
    const calculateItemValues = (index) => {
        ...
        const taxableValue = item.qty * item.price * (1 - item.discountPercent / 100);
                            ...
                            <TableCell>
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <Input type="number" {...field} className="bg-white" readOnly value={watch(`items.${index}.taxableValue`)} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                            ...
                            <TableCell>
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <Input type="number" {...field} className="bg-white" onChange={(e) => {
                                                    field.onChange(e)
                                                    calculateItemValues(index)
                                                    calculateTotals()
                                                }} />
                            ...
                            <TableCell>
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <Input type="number" {...field} className="bg-white" readOnly value={watch(`items.${index}.total`)} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
